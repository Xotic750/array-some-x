...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["arraySomeX"] = factory();
	else
		root["arraySomeX"] = factory();
})((function () {
  'use strict';
...
if (nativeSome) {
  ...
  if (isWorking) {
    spy = '';
    res = attempt.call(array_some_x_esm_castObject('abc'), nativeSome, function (item, index) {
      array_some_x_esm_newArrowCheck(this, array_some_x_esm_this);
...
//# sourceMappingURL=array-some-x.js.map