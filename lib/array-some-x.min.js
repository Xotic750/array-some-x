 ...
 * @module array-some-x
 */
"use strict";var toObject=_dereq_("to-object-x"),assertIsFunction=_dereq_("assert-is-function-x"),documentElement="undefined"!=typeof document&&document.documentElement,argObj=function(){return arguments}(1),nativeSome="function"==typeof Array.prototype.some&&Array.prototype.some;if(nativeSome)try{var worksWithStrings;if(nativeSome.call("abc",function(){return worksWithStrings=!0}),!0!==worksWithStrings)throw new Error("failed string");var worksWithArguments;if(nativeSome.call(argObj,function(){return worksWithArguments=!0,worksWithStrings}),!0!==worksWithArguments)throw new Error("failed arguments");if(documentElement){var fragment=document.createDocumentFragment(),div=document.createElement("div");fragment.appendChild(div);var worksWithDOMElements;if(nativeSome.call(fragment.childNodes,function(){return worksWithDOMElements=!0}),!0!==worksWithDOMElements)throw new Error("failed documentElement")}var tests={properlyBoxesNonStrict:!0,properlyBoxesStrict:!0};if(function(){return!1===Boolean(this)}()&&(nativeSome.call([1],function(){tests.properlyBoxesStrict="string"==typeof this},"x"),!0!==tests.properlyBoxesStrict))throw new Error("failed properlyBoxesStrict");var fn=['return nativeSome.call("foo", function (_, __, context) {','if (Boolean(context) === false || typeof context !== "object") {',"tests.properlyBoxesNonStrict = false;}});"].join("");if(Function("nativeSome","tests",fn)(nativeSome,tests),!0!==tests.properlyBoxesNonStrict)throw new Error("failed properlyBoxesNonStrict")}catch(ignore){nativeSome=null}var $some;if(nativeSome)$some=function some(array,callBack){var object=toObject(array),args=[assertIsFunction(callBack)];return arguments.length>2&&(args[1]=arguments[2]),nativeSome.apply(object,args)};else{var isString=!1===_dereq_("has-boxed-string-x")&&_dereq_("is-string"),isArguments=1!==argObj.length&&_dereq_("is-arguments"),toLength=_dereq_("to-length-x"),slice=_dereq_("array-slice-x"),isUndefined=_dereq_("validate.io-undefined");$some=function some(array,callBack){var object=toObject(array);assertIsFunction(callBack);var iterable;iterable=isString&&isString(object)||isArguments&&isArguments(object)?slice(object):object;var thisArg,length=toLength(iterable.length);arguments.length>2&&(thisArg=arguments[2]);for(var i=0;i<length;i+=1)if(i in iterable){if(isUndefined(thisArg)?callBack(iterable[i],i,object):callBack.call(thisArg,iterable[i],i,object))return!0}return!1}}module.exports=$some},{"array-slice-x":2,"assert-is-function-x":3,"has-boxed-string-x":6,"is-arguments":9,"is-string":19,"to-length-x":31,"to-object-x":33,"validate.io-undefined":40}],2:[function(_dereq_,module,exports){/**
 ...
 * @module to-object-x
 */
"use strict";var $requireObjectCoercible=_dereq_("require-object-coercible-x");module.exports=function ToObject(value){return Object($requireObjectCoercible(value))}},{"require-object-coercible-x":28}],34:[function(_dereq_,module,exports){/**
